...
* **Minor Synergy** (2 Properti) ➔ Sewa +15%
* **Major Synergy** (3 Properti) ➔ Sewa +30% & Diskon Bangun -10%
* **District Lord** (4+ Properti) ➔ Sewa melonjak +50% di seluruh distrik!
...
Sewa properti dihitung secara dinamis melalui formula 7 lapis:
```text
Sewa = Base × Bangunan × Monopoli (2x) × Sinergi Distrik × Event Ekonomi × Cuaca × Skill
```

**5 Pilihan Jalur Bangunan:**
* 🏨 **Hotel** (4 Rumah ➔ Hotel): Sewa tertinggi hingga 40x sewa dasar.
...
### 🌍 4. 16 Event Global & 11 Sistem Cuaca
...
### 📊 5. Pasar Saham Cyber, Pinjaman & Pasar Gelap
...
* **3 Skema Pinjaman**:
  ...
  * 🏠 *Gadai Properti* (Bunga 0%, terima 50% nilai aset).
* **Pasar Gelap (Black Market)**: Beli item selundupan ilegal (*Alat Mata-mata, Uang Palsu, Kunci Master, Surat Palsu, Perlindungan Sindikat, Stimulan*) dengan risiko razia penjara.
...
### 💬 6. Room & In-Game Live Chat System
* **Lobby Chat**: Mengobrol di ruang tunggu dengan daftar pemain dan tombol *Quick Taunt Chips* (`👋 Halo!`, `🔥 Gas!`, `🎲 GL!`, `🤑 Sultan!`).
* **In-Game Chat Drawer**: Panel chat samping yang dapat dibuka/ditutup tanpa menghalangi papan, dilengkapi *Unread Notification Badge* dan gelembung melayang (*Floating Toast Previews*).
...
### 📜 7. Riwayat Pertandingan Live & Log Event Lengkap (*Live Match History & Event Feed*)
...
Game ini dibangun dengan pendekatan **High-Performance Hybrid Architecture (WebAssembly Rust Core + Zero-Dependency Vanilla Web Stack)**:
...
│   └── engine.cpp        # Source Code C++ Engine (Emscripten / Clang compatible)
├── css/
...
│   ├── guide.js          # Buku Panduan Interaktif 18 Bab (Guidebook)
...
│   ├── skills.js         # Logika skill pasif & aktif 6 karakter
...
* **Audio Node Garbage Collection**: Pemutusan koneksi Web Audio Oscillator secara otomatis untuk mencegah kebocoran memori pada browser mobile.
...
2. Masukkan **Nama Pemain** dan pilih **Karakter Spesialisasi**.
