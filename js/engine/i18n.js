...
class I18nEngine {
  ...
  applyTranslations() {
    ...
    const langBadgeMobile = document.getElementById('current-lang-badge-mobile');
    const textBadge = this.currentLang === 'id' ? '🇮🇩 ID' : '🇬🇧 EN';
    if (langBadge) langBadge.textContent = textBadge;
    if (langBadgeMobile) langBadgeMobile.textContent = textBadge;
