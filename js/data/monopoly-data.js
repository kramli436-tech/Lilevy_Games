...
const CHARACTER_ABILITIES = {
  ...
  '🎩': {
    ...
    desc: 'Diskon 10% setiap beli tanah & bonus petak MULAI bertambah Rp 500.000.',
  ...
  '🏎️': {
    name: 'Juara Formula',
    desc: 'Sewa properti kota megapolitan (Tokyo/New York/Paris/Jakarta) +30%.',
    perk: 'SPEED_CHAMPION',
    icon: 'flame'
  },
  '👑': {
    name: 'Kaisar Properti',
    desc: 'Diskon 15% bangun rumah & kebal bebas sewa 1x saat pertama kali mendarat di properti lawan.',
    perk: 'EMPEROR_SHIELD',
    icon: 'gem'
  },
  '🤖': {
    name: 'AI Cyber Master',
    desc: 'Diskon 20% biaya upgrade gedung & diskon 10% beli properti baru.',
    perk: 'CYBER_DISCOUNT',
    icon: 'bot'
  },
  '💎': {
    name: 'Ratu Permata',
    desc: 'Menerima dividen kas Rp 500.000 dari bank setiap kali pemain lain mendarat di tanah miliknya.',
    perk: 'GEM_DIVIDEND',
    icon: 'sparkles'
  },
  '🐉': {
    name: 'Naga Keberuntungan',
    desc: 'Bonus +50% saat memenangkan hadiah kasino roda keberuntungan & lelang terbuka.',
    perk: 'DRAGON_LUCK',
    icon: 'sparkles'
  },
  '🛡️': {
    name: 'Ksatria Pelindung',
    desc: 'Mendapat potongan diskon 20% untuk semua denda sewa yang harus dibayarkan ke lawan.',
    perk: 'KNIGHT_DEFENSE',
    icon: 'shield-check'
  },
  '🛸': {
    name: 'Penjelajah Antariksa',
    desc: 'Setiap melewati Stasiun/Warp Gate menerima subsidi energi Rp 500.000 tunai.',
    perk: 'COSMIC_ENERGY',
    icon: 'orbit'
  },
  '🦁': {
    name: 'Raja Rimba',
    desc: 'Pendapatan sewa seluruh petak cagar alam & kepulauan bertambah +35%.',
    perk: 'WILD_BOOST',
    icon: 'award'
  },
  '🧙‍♂️': {
    name: 'Penyihir Waktu',
    desc: 'Kebal bebas 100% dari seluruh tagihan denda petak Pajak!',
    perk: 'TAX_IMMUNITY',
    icon: 'wand'
  },
  '🦄': {
    name: 'Pegasus Mistis',
    desc: 'Bonus gaji petak MULAI bertambah Rp 750.000 tunai.',
    perk: 'PEGASUS_REWARD',
    icon: 'star'
  }
};
...
const ECONOMIC_EVENTS = [
  ...
  {
    id: 'ROYAL_CORONATION',
    title: '👑 Penobatan Duta Ekonomi Monopoli',
    desc: 'Pemain dengan total aset tertinggi dinobatkan menjadi Duta Ekonomi, kebal seluruh denda sewa selama 2 putaran!',
    scope: 'TARGETED_ADVANTAGE',
    type: 'success',
    effectType: 'SHIELD_RICHEST',
    duration: 2
  },
  ...
  {
    id: 'WALL_STREET_RALLY',
    title: '📈 Reli Pasar Modal Wall Street',
    desc: 'Pasar saham dunia melonjak drastis! Seluruh pemain menerima dividen tunai Rp 1.500.000!',
    scope: 'GLOBAL_ADVANTAGE',
    type: 'success',
    effectType: 'GLOBAL_DIVIDEND',
    dividendAmount: 1500000,
    duration: 1
  },
  {
    id: 'FINTECH_REVOLUTION',
    title: '🌐 Revolusi FinTech & Smart City',
    desc: 'Transaksi perbankan digital aktif! Setiap bayar sewa tanah memberikan cashback 20% dari kas pusat!',
    scope: 'GLOBAL_ADVANTAGE',
    type: 'info',
  ...
  {
    id: 'GREEN_SUBSIDY',
    title: '🌿 Subsidi Konstruksi Hijau',
    desc: 'Pemerintah mendiskon 50% biaya membangun Rumah, Hotel, dan Pencakar Langit (Sky)!',
    scope: 'GLOBAL_ADVANTAGE',
    type: 'success',
    costMultiplier: 0.5,
    duration: 3
  ...
  {
    id: 'BULL_MARKET_MONOPOLY',
    title: '🐂 Booming Pasar Monopoli',
    desc: 'Nilai sewa pemilik hak monopoli 1 set warna lengkap meningkat menjadi 3x lipat!',
    scope: 'GLOBAL_ADVANTAGE',
    type: 'success',
    monopolyMultiplier: 1.5,
    duration: 3
  },
  {
  ...
  {
    id: 'WORLD_EXPO_CARNIVAL',
    title: '🎪 World Expo & Karnaval Budaya',
    desc: 'Festival global berlangsung! Seluruh pemain yang mendarat di petak apapun mendapat souvenir Rp 500.000!',
    scope: 'GLOBAL_ADVANTAGE',
    type: 'success',
    effectType: 'GLOBAL_EXPO',
    expoBonus: 500000,
    duration: 3
  },

  // --- D. GLOBAL: MERUGIKAN / REDISTRIBUSI ---
  {
    id: 'WEALTH_REDISTRIBUTION',
    title: '⚖️ Solidaritas Pajak Redistribusi Kekayaan',
    desc: 'Pemain terkaya menyumbangkan 10% uang kas untuk dibagikan merata ke pemain lain!',
    scope: 'GLOBAL_DISADVANTAGE',
    type: 'info',
    effectType: 'REDISTRIBUTE_WEALTH',
    percent: 0.10,
    duration: 1
  },
  {
  ...
  },
  {
    ...
    title: '⚓ Krisis Rantai Pasok Maritim',
    desc: 'Jalur logistik terhambat! Sewa seluruh Stasiun & Bandara naik 2.5x lipat!',
    scope: 'GLOBAL_DISADVANTAGE',
    type: 'warning',
    stationMultiplier: 2.5,
    duration: 3
  },
  {
    id: 'HYPERINFLATION',
