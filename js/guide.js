  ...
  function getPages() {
    ...
    const pages = [
      ...
      },
      {
        ...
        content: lang === 'id'
          ? '<h3>Sistem Pembelian</h3><p>Saat mendarat di properti tanpa pemilik, kamu bisa membelinya langsung. Jika kamu menolak, properti akan otomatis dilempar ke <strong>Lelang Publik</strong>!</p><h3>Monopoli Grup Warna</h3><p>Memiliki seluruh properti dalam satu grup warna = <strong>Monopoli Penuh</strong>! Sewa dasar naik 2x lipat dan izin pembangunan terbuka.</p><h3>Formula Sewa 7-Tier</h3><p>Sewa dihitung secara dinamis berlapis:</p><code>Sewa = Base × Bangunan × Monopoli (2x) × Sinergi Distrik × Event Ekonomi × Cuaca × Skill Karakter</code><p>Kombinasi modifier ini bisa menghasilkan sewa mematikan hingga ribuan dollar!</p>'
          : '<h3>Purchase System</h3><p>When landing on unowned property, buy it directly. If declined, it enters a <strong>Public Auction</strong>!</p><h3>Color Group Monopoly</h3><p>Own all properties in the same color group = <strong>Full Monopoly</strong>! Base rent doubles and construction unlocks.</p><h3>7-Tier Rent Formula</h3><p>Rent is dynamically calculated:</p><code>Rent = Base × Building × Monopoly (2x) × District Synergy × Economy Event × Weather × Character Skill</code><p>These stacking multipliers can create devastating four-figure rent strikes!</p>'
      },
      {
        title: lang === 'id' ? '🏗️ 5 Jalur Pembangunan' : '🏗️ 5 Building Paths',
        content: lang === 'id'
          ? '<h3>Pilih Strategi Pembangunan</h3><p>Setiap properti ber-monopoli dapat dibangun dengan salah satu jalur arsitektur:</p><ul><li>🏨 <strong>Hotel</strong> (4 Rumah → Hotel): Penghasil sewa terbesar (hingga 40x sewa dasar).</li><li>🏬 <strong>Mall Bisnis</strong> (2 Rumah → Mall): Memberikan penghasilan pasif kas +$50 setiap giliran.</li><li>🏢 <strong>Markas Besar / HQ</strong> (2 Rumah → HQ): Menggandakan efek skill karakter saat berada di petak ini.</li><li>🎰 <strong>Kasino Mewah</strong> (1 Rumah → Kasino): Sewa acak bertaruh antara 0.5x hingga 3.0x lipat.</li><li>🏰 <strong>Benteng Pertahanan / Fortress</strong> (3 Rumah → Benteng): Kebal 100% dari serangan kartu sabotase dan bencana alam!</li></ul>'
          : '<h3>Choose Your Construction Path</h3><p>Monopoly properties can be developed into specialized architectural structures:</p><ul><li>🏨 <strong>Hotel</strong> (4 Houses → Hotel): Highest rent output (up to 40x base rent).</li><li>🏬 <strong>Shopping Mall</strong> (2 Houses → Mall): Generates +$50 passive cash income every turn.</li><li>🏢 <strong>Corporate HQ</strong> (2 Houses → HQ): Doubles active skill effects on this tile.</li><li>🎰 <strong>Casino</strong> (1 House → Casino): Gambles random rent multiplier from 0.5x to 3.0x.</li><li>🏰 <strong>Fortress</strong> (3 Houses → Fortress): 100% immune to sabotage cards and natural disasters!</li></ul>'
      },
      {
        title: lang === 'id' ? '⚡ 6 Karakter & Skill' : '⚡ 6 Characters & Skills',
        content: lang === 'id'
          ? '<h3>Skill Pasif & Aktif Karakter</h3><ul><li>💼 <strong>Banker</strong> — Pasif: Bunga pinjaman bank hanya 3% | Aktif: Bekukan sewa 1 properti lawan selama 2 giliran.</li><li>🔧 <strong>Engineer</strong> — Pasif: Diskon biaya pembangunan 20% | Aktif: Bangun 1 level rumah gratis seketika.</li><li>📈 <strong>Trader</strong> — Pasif: Melihat arah tren saham lebih awal | Aktif: Paksa pertukaran properti dengan lawan.</li><li>🎩 <strong>Politician</strong> — Pasif: Kebal semua petak pajak kota | Aktif: Tarik pajak 15% dari uang seluruh lawan.</li><li>🎲 <strong>Gambler</strong> — Pasif: Opsi lempar ulang dadu 1x/giliran | Aktif: Gandakan seluruh sewa propertimu 2x lipat.</li><li>🛡️ <strong>Guardian</strong> — Pasif: Kebal lelang paksa | Aktif: Pasang perisai kebal sewa 2 kali mendarat.</li></ul>'
          : '<h3>Character Passive & Active Skills</h3><ul><li>💼 <strong>Banker</strong> — Passive: Bank loan interest only 3% | Active: Freeze opponent property rent for 2 turns.</li><li>🔧 <strong>Engineer</strong> — Passive: -20% building construction cost | Active: Build 1 free house instantly.</li><li>📈 <strong>Trader</strong> — Passive: View stock trend shifts early | Active: Force trade a property with opponent.</li><li>🎩 <strong>Politician</strong> — Passive: Immune to all tax tiles | Active: Levy 15% tax on all opponents cash.</li><li>🎲 <strong>Gambler</strong> — Passive: Reroll dice 1x per turn | Active: Double all your property rents for 2 turns.</li><li>🛡️ <strong>Guardian</strong> — Passive: Immune to forced auctions | Active: Energy shield skips rent 2 times.</li></ul>'
      },
      {
